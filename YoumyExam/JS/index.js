...
$(".threeLines").on("click", function () {
  ...
  $("#iconOpen").removeClass("fa-solid fa-grip-lines");
  $("#iconOpen").addClass("fa-brands fa-square-x-twitter");
  $("#iconOpe").removeClass("fa-solid fa-grip-lines");
  $("#iconOpe").addClass("fa-brands fa-square-x-twitter");
...
$(".close-icon").on("click", function () {
  ...
  $("#iconOpen").removeClass("fa-brands fa-square-x-twitter");
  $("#iconOpen").addClass("fa-solid fa-grip-lines");
  $("#iconOpe").removeClass("fa-brands fa-square-x-twitter");
  $("#iconOpe").addClass("fa-solid fa-grip-lines");
});
...
async function displayMain(input) {
  ...
  for (let i = 0; i < meals.length; i++) {
    container += `
        ...
        <div class="main-card position-relative border-0 d-flex overflow-hidden">
        <img src="${meals[i].strMealThumb}" class="w-100" alt="...">
        <div class="card-ovlay d-flex align-items-center top-100 w-100 h-100 position-absolute">
...
async function search() {
  ...
  let inputs = `
            ...
            <input type="text" class="form-control bg-transparent text-white" id="searchN" placeholder="search By Name">
            </div>
            <div class="col-md-6">
            <input type="text" class="form-control bg-transparent text-white" id="searchF" placeholder="search By first latter" maxlength="1">
            <div>
            </div>
            `;
...
async function displayCategories() {
  ...
  for (let i = 0; i < cates.length; i++) {
    ...
    container += `
        <div class="text-bg-dark col-md-3 mainCol cursor-pointer">
        <div class="main-card position-relative border-0 d-flex overflow-hidden" onclick="filterCategory(this.id)" id="${
          cates[i].strCategory
        }">
                        <img src="${
                          cates[i].strCategoryThumb
                        }" class="w-100 bg-dark" alt="...">
                        <div class="card-ovlay-categore d-flex flex-column justify-content-center align-items-center top-100 w-100 h-100 position-absolute">
...
async function displayThemealdb() {
  ...
  for (let i = 0; i <= 19; i++) {
    container += `
        ...
        <h3 class="text-white">${meals[i].strIngredient}</h3>
        <p class="text-white">${meals[i].strDescription.split(" ", 20).join(" ")}</P>
        </div>
        </div>
        </div>
        `;
...
async function displayContact() {
  let inputs = `
<div class="container w-75 h-100 vh-100 d-flex flex-column justify-content-around align-items-center text-center bg-dark">
        <div class="row g-4">
            <div class="col-md-6">
